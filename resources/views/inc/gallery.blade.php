...
<section id="gallery" class="wow fadeInUp">
    <div class="container">
        <div class="section-header">
            <h2>Galerija</h2>
            <p>Nuotraukos iš renginių ir serverių</p>
        </div>
    </div>
    <div class="owl-carousel gallery-carousel">
        ...
        <a href="{{asset("image/gallery/6.jpg")}}" class="venobox" data-gall="gallery-carousel"><img src="{{asset("image/gallery/6.jpg")}}" alt=""></a>
        <a href="{{asset("image/gallery/7.jpg")}}" class="venobox" data-gall="gallery-carousel"><img src="{{asset("image/gallery/7.jpg")}}" alt=""></a>
        <a href="{{asset("image/gallery/8.jpg")}}" class="venobox" data-gall="gallery-carousel"><img src="{{asset("image/gallery/8.jpg")}}" alt=""></a>
    </div>
</section>